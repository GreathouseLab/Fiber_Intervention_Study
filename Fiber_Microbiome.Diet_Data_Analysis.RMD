...
diet_data <-  read.delim("C:/Users/Jordan/Box/Diet Data/Final Study Dietary Data_ASA24/BFiber_2019-06-26_52817/BFiber_2019-06-26_52817_Totals.txt")
...
#Total Fiber Intake
ggplot(data=fiber_data, aes(x=fiber_data$RecallNo, y=fiber_data$FIBE))+
  geom_col(fill="white", color="black")+
  facet_wrap(vars(fiber_data$UserName))+
  labs(title="Individual Fiber Intake", x="RecallNo", y= "g of Fiber")
...
ggplot(data=fiber_data, aes(x=fiber_data$RecallNo, y=fiber_data$g_per_1000KCAL))+
  ...
  facet_wrap(vars(fiber_data$UserName))+
  labs(title="Individual Fiber/1000 KCAL", x="RecallNo", y= "g/1000 KCAL")
```
...
ggplot(data=CombinedFiber, aes(x=CombinedFiber$Respondent.ID, y=CombinedFiber$grams, fill=Type))+
  ...
  labs(title= "Consumption of Fiber", x= "Subject", y= "grams of Fiber")
```
