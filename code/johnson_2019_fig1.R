...
map <- read.table(paste0(w.d,"/data/johnson2019/SampleID_map.txt"), sep = "\t", header = T, comment = "")
...
food <- read.table(paste0(w.d,"/data/johnson2019/dhydrt.txt"), header = T, sep = "\t", comment = "", row.names = "taxonomy")
...
plot3 <- reshape2::melt(plot3, id = "X.SampleID", variable.name = "Food")
